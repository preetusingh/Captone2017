...
class DetailViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    var currentBounty : Bounty!
    var nearbyBounties : [Bounty]?
...
extension DetailViewController : UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
    ...
    func getNearByClaimedBounties(success:@escaping ()->()){
        ...
        if let geoPoint = location?.geoPoint {
            server.fetchClaimedBountyNear(location: geoPoint, withInMiles: searchDistanceInMiles, success: { (bounties : [Bounty]?) in
    ...
    func setUpCollectionView(){
        ...
        collectionView.register(NearByClaimedCollectionCell.self, forCellWithReuseIdentifier: "NearByClaimedCollectionCell")
        collectionView.delegate = self
        collectionView.dataSource = self
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "NearByClaimedCollectionCell", for: indexPath) as! NearByClaimedCollectionCell
    ...
    func collectionView(_ collectionView: UICollectionView, willDisplay cell: UICollectionViewCell, forItemAt indexPath: IndexPath) {
        let collectionCell = cell as! NearByClaimedCollectionCell
